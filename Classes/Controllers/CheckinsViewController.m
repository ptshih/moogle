...
- (void)setupButtons {  
  UIBarButtonItem *distanceButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"btn-distance.png"] style:UIBarButtonItemStyleBordered target:self action:@selector(toggleDistance)];
